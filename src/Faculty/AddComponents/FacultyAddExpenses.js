...
import Facultydocuments from "../Facultydocuments";
...
class FacultyAddExpenses extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const { id, cost, exp_date, exp_name, item_count, month } = this.state;
    return (
      <form className="facultyAddExpenses" onSubmit={this.submitHandler}>
        {/* <div className="modal">
          ...
          <div className="floatleft">
            <div className="">
              ...
              {this.state.exp_name_error ? (
                <div style={{ color: "red" }}>{this.state.exp_name_error}</div>
              ) : null}
            </div>
            ...
            <div className="">
              ...
              {this.state.exp_type_error ? (
                <div style={{ color: "red" }}>{this.state.exp_type_error}</div>
              ) : null}
            </div>
    ...
    {this.state.id_error}
            ...
            <div className="">
              ...
              {this.state.exp_date_error ? (
                <div style={{ color: "red" }}>{this.state.exp_date_error}</div>
              ) : null}
            </div>
          </div>
...
export default FacultyAddExpenses;
