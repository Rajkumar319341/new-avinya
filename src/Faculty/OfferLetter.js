...
class OfferToPrint extends Component {
    state = {
        name: "",
        address: "",
        designation: "",
    ...
    async componentDidMount() {
        ...
        const emailid = btoa(sessiondetails.email);
        const urlenrollmentStatus = APIData.api + "enrollments/data?emailId=" + emailid;
                ...
                <div className="termsAndCondition">
                    <div className="carrybox">
                        <div id="policy2">
                            ...
                            <div className="">
                                <h3 className="heading01">{APIData.orgName}</h3>
                            </div>
                            <div className="bringitcenter">
                            ...
                            <b>Subject:</b> Offer letter for the role of {this.state.designation} Trianer<br /><br />
                            <p><b>Dear {this.state.name},</b></p>
                            <br />
                            We are pleased to inform you that you have been selected to join the <b>{APIData.orgName} </b>
                            as an {this.state.designation}. The joining date we have decided for you is {this.state.date}.
                            <br />
                            We are confident you will be able to make a significant contribution to the success of <b>{APIData.orgName} </b> and look forward to working with you.
                            <br /><br />
...
export default class OfferLetter extends React.Component {
    constructor(props) {
      super(props);
    ...
    render() {
      return (
        <React.Fragment>
          <OfferToPrint ref={this.componentRef} />
