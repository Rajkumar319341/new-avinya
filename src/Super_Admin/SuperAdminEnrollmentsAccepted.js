...
class SuperEnrollmentsAccepted extends Component {
  state={ 
      loading: true,
      enrolldata: null
  };
 async componentDidMount(){
  ...
  return (
    ...
    <div className="superEnrollmentsAccepted">
...
{this.state.loading || !this.state.enrolldata ? <Loading /> : 
    ...
    <CSVLink data={this.state.enrolldata} filename={'AcceptedEnrollments'}>
...
export default SuperEnrollmentsAccepted;