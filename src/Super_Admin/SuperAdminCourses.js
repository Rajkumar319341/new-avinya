...
import CourseData from "../SQLTables/CourseData";
import { CSVLink, CSVDownload } from "react-csv";
import * as FaIcons from "react-icons/fa";
class SuperAdminCourse extends Component {
   state={
    loading: true,
    user:null 
};
async componentDidMount(){
  ...
  render() { 
    return ( 
      <div className="superAdminCourse">
      {this.state.loading || !this.state.user? <Loading />: 
        <p>
<div className="carrybox">
<CourseData data={this.state.user}/>
</div>
<CSVLink data={this.state.user} filename={'Courses'}>
