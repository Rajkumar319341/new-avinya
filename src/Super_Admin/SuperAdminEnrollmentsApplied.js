...
class SuperAdminEnrollmentsApplied extends Component {
  state={
      loading: true,
      enrolldata: null
  };
...
{this.state.loading || !this.state.enrolldata ? <Loading /> : 
    ...
    <CSVLink data={this.state.enrolldata} filename={'AppliedEnrollments'}>
...
export default SuperAdminEnrollmentsApplied;