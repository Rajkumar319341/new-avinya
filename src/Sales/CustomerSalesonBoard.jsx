            ...
            <Container component="main" maxWidth="md">
              ...
              <Box sx={{ marginTop: 8 }}>
                ...
                <form onSubmit={handleSubmit}>
                  <Grid container spacing={3}>
                    <Grid item xs={12} sm={6}>
                      <TextField label="Customer Name" required fullWidth name='customerName' onChange={handleChange} value={formData.customerName} helperText="Customer Name to Onboard" />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <TextField label="Customer Email" required fullWidth name='customerEmail' onChange={handleChange} value={formData.customerEmail} helperText="Customer Email Address"/>
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <TextField label="Org Name" required fullWidth name='org_name' onChange={handleChange} value={formData.org_name}  helperText="Organization Name Ex: Care4Edu Pvt limited"/>
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <TextField label="Customer Ph no" required fullWidth name='customerMobileNum' onChange={handleChange} value={formData.customerMobileNum} inputProps={{
                        maxLength: 10,
                        pattern: "[0-9]*"
                      }} helperText="Customer Mobile Number to Contact"
                      />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <TextField label="Customer Address" required fullWidth name='customerAddress' onChange={handleChange} value={formData.customerAddress} helperText="Customer Address" />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <TextField label="Customer GST" required fullWidth name='customerGST' onChange={handleChange} value={formData.customerGST} helperText="Customer GST " />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <FormControl fullWidth>
                        <InputLabel id="month">Month</InputLabel>
                        <Select
                          ...
                          label="Month"
                          onChange={handleChange}
                          helperText=" Select Month of Onboarding"
                        >
                          <MenuItem value="JAN">JAN</MenuItem>
                          <MenuItem value="FEB">FEB</MenuItem>
                          <MenuItem value="MARCH">MARCH</MenuItem>
              ...
              <TextField  label="Org" name='org' onChange={handleChange} value={formData.org}  fullWidth/>
                    ...
                    <Grid item xs={12} sm={6}>
                      <FormControl fullWidth>
                        ...
                        <Select
                          ...
                          label="Sales Type"
                          onChange={handleChange}
                          helperText="Select the Sales Type Ex: PROSPECT,LEAD,OPPORTUNITY"
                        >
                          <MenuItem value="PROSPECT">PROSPECT</MenuItem>
                          <MenuItem value="LEAD">LEAD</MenuItem>
                          <MenuItem value="OPPORTUNITY">OPPORTUNITY</MenuItem>
                    ...
                    <Grid item xs={12} sm={6}>
                      <TextField label="Sales Year" required name='salesYear' onChange={handleChange} value={formData.salesYear.substring(0, 4)} InputLabelProps={{
                        shrink: true,
                      }}  fullWidth helperText="Select Sales Year " />
                    </Grid>
                    {/* <Grid item xs={12} sm={6}>
                      <TextField label="Created By" required name='created_by' onChange={handleChange} value={formData.username} fullWidth />
                    </Grid> */}
