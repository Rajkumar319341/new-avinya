...
class WeatherApp extends React.Component {
    ...
    buildUrlApi = () => {
      ...
      const urlSuffix = "&appid=25769898d82dd8b99c94342d15116f44&units=metric";
    ...
    render() {
      ...
      return (
        ...
        <div className='WeatherTry'><div className={"widget ".concat(...background)}>
